...
**3. Funding rate, counter or opposite.** The flow slide says "counter/opposite" and the table says negative funding = long. Read together: trade against the funding rate. Spoken: funding settles **three times a day, 8 AM, 4 PM and midnight Malaysian time** (00:00, 08:00, 16:00 UTC); hold across one and you pay or receive it. In practice he scores **the sign only**: his live screen read −0.0021%, which is inside the handouts' "balanced" band, and he counted it as negative and therefore long. Negative funding means the crowd is net short and shorts pay longs. Going long means you are paid to hold, and you are positioned against a crowded side that can be squeezed. For a short, look for positive funding.

**4. Depth, "choose the lower volume".** **Resolved (notes/08 part 4): lighter bid (green) side → long; lighter ask (red) side → short.** His own depth screenshot shows bids 323,220 against asks 364,732 and he calls it Up, so this is the taught rule, not a slip. It is the reverse of the handouts, which use the textbook "path of least resistance" reading. His version treats resting orders as a magnet, the same logic the course applies to liquidation clusters. The tools default to the session rule and can switch to the handout rule.
