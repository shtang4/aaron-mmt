...
| ~~A12~~ | ~~Depth check direction?~~ Resolved by his own depth screenshot (bids 323,220 vs asks 364,732, verdict "Up"): **lighter bid → long.** The handout row is set aside. | 8 part 4 | |
...
| E4 | Which timeframe is the EMA cross-back exit read on? | 1 §3.3 | On 1m it is late; on 15m it is a different trade. **Now known to be an unanswered question inside the course itself:** deck p.35 shows a student asking, verbatim, "when 4/4 confirmed short, do we still need to check the MACD before enter the market? **which TF should we observe before enter**..." and the reply (Jasper Sia, 21/04/2024) gives an order of operations — "1. 4/4  2. volume 是否活跃  3. macd, 配合黄金或死亡交叉更好" — **without naming a timeframe**. Ask him directly; the community answer does not have it either. |
| E5 | Is there a minimum reward-to-risk ratio? | 1 §3.3 | Still never *stated*, but no longer without an anchor. Deck **p.62** posts a complete SOMI trade call (`Ent 1.0059 / SL 0.9551 / TP1 1.1863`) with the TradingView tool reading **"Risk/Reward Ratio: 3.72"** — stop 4.82% of entry, target 17.93%. Checked: 0.1804 ÷ 0.04811 = 3.75. So the one call he shows fully specified is planned at about **3.7 : 1**. Reframe the question from "is there a floor?" to **"is 3:1 the floor, since that is how you sized SOMI?"** See `05 §6.1`. |
